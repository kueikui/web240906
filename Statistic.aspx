    ...
    <main aria-labelledby="title" class="panel-container">
        ...
        <div class="chart-container ">            
            ...
            <asp:Panel ID="Panel3" runat="server" Visible="False">
                <div class="chart">
                    <asp:Chart ID="Chart5" runat="server" Height="250px" BackColor="powderblue">
                ...
                <div class="chart">
                    <asp:Chart ID="Chart6" runat="server" Height="250px" BackColor="powderblue">
                ...
                <br />
                <div class="chart">
                    <asp:Chart ID="Chart7" runat="server" Height="250px" BackColor="powderblue">
            ...
            <asp:Panel ID="Panel5" runat="server" Visible="False">
                <div class="chart">
                    <asp:Chart ID="Chart8" runat="server" AlternateText="載入失敗" BorderlineWidth="0" Height="250px" BackColor="powderblue">
                        <Legends><asp:Legend AutoFitMinFontSize="5" Name="Legend1" Title="人數"></asp:Legend></Legends>
                ...
                <div class="chart">
                    <asp:Chart ID="Chart9" runat="server" Height="250px" BackColor="powderblue">
                ...
                <br />
                <div class="chart">
                    <asp:Chart ID="Chart10" runat="server"  Height="250px" BackColor="powderblue">
                        <Legends><asp:Legend AutoFitMinFontSize="5" Name="Legend1" Title="原因"></asp:Legend></Legends>
