...
namespace WebViewExample
{
    public partial class Form1 : Form
    {
        ...
        {
            // 创建一个Panel来包含WebBrowser
            Panel panel = new Panel
            {
                Dock = DockStyle.Top,
                Height = 240,
                Padding = new Padding(16),
                BackColor = System.Drawing.Color.FromArgb(255, 240, 224)
            };
            ...
            {
                Dock = DockStyle.Fill,
                ScriptErrorsSuppressed = true // 取消显示脚本错误
            };
            ...
            // 加载指定的URL
            webBrowser.Navigate("http://203.64.84.154:8088");

            // 将WebBrowser添加到Panel中
            ...
            {
                Text = "即时画面",
                Font = new System.Drawing.Font("Microsoft Sans Serif", 24, System.Drawing.FontStyle.Bold),
                Dock = DockStyle.Top,
                Padding = new Padding(16)
            };
        ...
        {
            // 页面加载完成时触发
            Console.WriteLine("Page Loaded: " + e.Url.ToString());
        }

        private void WebBrowser_Navigating(object sender, WebBrowserNavigatingEventArgs e)
        {
            // 页面导航时触发
            if (e.Url.ToString().StartsWith("http://203.64.84.154:8088/video_feed"))
            {
                // 阻止特定URL的导航
                e.Cancel = true;
                Console.WriteLine("Navigation prevented: " + e.Url.ToString());
            }
        }
